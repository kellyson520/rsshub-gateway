...
import { createUraakaFetcher } from './fetcher.js';

const PORT = Number.parseInt(process.env.FETCHER_PORT || '', '10') || 8014;
...
async function main() {
  ...
  await listen(server, PORT, '0.0.0.0', 'fetcher_uraaka');
