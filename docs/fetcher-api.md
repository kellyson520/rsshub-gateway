...
| `sidecar/fetcher-jable` | `/jable/new-release/:page?`、`/jable/videos/:page?`、`/jable/search/:keyword/:page?`、`/jable/video/:code` | jable.tv | 新作/全部/搜索/单集 feed；CF 托管挑战由浏览器渲染服务通过，封面/预览走 assets-cdn.jable.tv 媒体代理 |
