...
- [x] **Step 1: Write failing period and parser tests**
...
- [x] **Step 3: Implement the minimal parser and RSS renderer**
...
- [x] **Step 5: Commit the adapter parser**
...
- [x] **Step 1: Write failing host and lazy-image tests**
...
- [x] **Step 3: Implement registration, allowlist, and lazy-image normalization**
...
- [x] **Step 5: Commit the host and reader support**
...
- [x] **Step 3: Implement the ranking route**
...
- [x] **Step 5: Commit the gateway route**
...
- [x] **Step 1: Document public ranking URLs and limitations**
...
- [x] **Step 3: Synchronize production source and rebuild**
...
- [x] **Step 4: Perform public acceptance checks**
...
- [x] **Step 5: Commit documentation and verify repository state**
...
- [x] Four ranking periods map to the expected public E-Hentai toplists.
- [x] Ranking HTML is parsed into bounded, valid RSS with escaped text.
- [x] E-Hentai gallery and image hosts are allowlisted without opening arbitrary hosts.
- [x] Gallery navigation and lazy-loaded images become signed gateway URLs.
- [x] Invalid ranking paths and upstream failures have safe status handling.
- [x] Existing Telegram and Iwara feeds remain green.
- [x] Production health, readiness, three gallery details, and one media range request pass.
- [x] No credentials, provider subscriptions, or private ExHentai content enter Git.
