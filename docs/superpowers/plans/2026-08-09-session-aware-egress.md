...
- [x] **Step 5: Commit the isolated task**
...
- [x] **Step 1: Write failing persistence and stability tests**
...
- [x] **Step 3: Implement HMAC fingerprinting and atomic persistence**
...
- [x] **Step 1: Write failing Controller binding tests**
...
- [x] **Step 3: Add separate session lane infrastructure**
...
- [x] **Step 4: Run tests and validate the runtime config**
...
- [x] **Step 5: Commit source/config-example changes**
...
- [x] **Step 1: Write failing upstream tests**
...
- [x] **Step 2: Run the upstream tests and verify red**
...
- [x] **Step 3: Implement scope-aware transport**
...
- [x] **Step 4: Run the upstream tests and verify green**

Run: `node --test test/upstream.test.js`

Expected: all existing lease/retry tests and new public/session assertions pass.

- [x] **Step 5: Commit the transport task**
...
- [x] **Step 1: Write failing metadata and cache tests**
...
- [x] **Step 3: Implement protected scope metadata and namespace keys**
...
- [x] **Step 5: Commit the route/cache task**
...
- [x] **Step 3: Wire the response-driven flow**
...
- [x] **Step 5: Commit the integration task**
...
- [x] **Step 1: Add explicit session runtime settings**
...
- [x] **Step 2: Validate the private Mihomo configuration before restart**
...
- [x] **Step 3: Document the routing contract**
...
- [x] **Step 4: Commit runtime wiring documentation**
...
- [x] **Step 3: Rebuild and restart the gateway**
...
- [x] **Step 5: Push only the verified public commits**
